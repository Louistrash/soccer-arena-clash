...
/** @type {string} */
const CACHE_VERSION = '1771492681|4756374158';
/** @type {string} */
const CACHE_PREFIX = 'Soccer Arena Cla-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'index.offline.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["index.offline.html","index.offline.js","index.offline.offline.html","index.offline.icon.png","index.offline.apple-touch-icon.png","index.offline.audio.worklet.js","index.offline.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["index.offline.wasm","index.offline.pck"];
